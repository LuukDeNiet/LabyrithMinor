...
struct  ExtendedKeyUsageExtension_t681  : public X509Extension_t675
{
	// System.Collections.ArrayList Mono.Security.X509.Extensions.ExtendedKeyUsageExtension::keyPurpose
	ArrayList_t640 * ___keyPurpose_3;
};
struct ExtendedKeyUsageExtension_t681_StaticFields{
	...
	Dictionary_2_t175 * ___U3CU3Ef__switchU24map14_4;
};
